      ...
      exports.run = async (bot, message, args, tools) => {
        ...
        function random(min, max) {
          ...
          const huntlist = [
            ...
            "ты встетил оленя... за продажу его рогов ты получил",
...
if (huntlist[index] == "ты встетил оленя... за продажу его рогов ты получил") image = ("https://i.imgur.com/FP1lC0u.jpg");
